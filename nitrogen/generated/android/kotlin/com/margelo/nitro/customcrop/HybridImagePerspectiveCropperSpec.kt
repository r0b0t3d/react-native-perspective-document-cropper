...
abstract class HybridImagePerspectiveCropperSpec: HybridObject() {
  ...
  @DoNotStrip
  @Keep
  private fun detectRectangleForImage(image: String, onSuccess: Func_void_Rectangle, onError: Func_void_std__string): Unit {
    val __result = detectRectangleForImage(image, onSuccess.toLambda(), onError.toLambda())
    return __result
  }
  ...
  @DoNotStrip
  @Keep
  private fun cropImage(image: String, rectangle: Rectangle, onSuccess: Func_void_std__string, onError: Func_void_std__string): Unit {
    val __result = cropImage(image, rectangle, onSuccess.toLambda(), onError.toLambda())
    return __result
  }
