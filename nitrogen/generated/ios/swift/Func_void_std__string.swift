...
/**
 * Wraps a Swift `(_ image: String) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_std__string {
  public typealias bridge = margelo.nitro.customcrop.bridge.swift

  private let closure: (_ image: String) -> Void

  public init(_ closure: @escaping (_ image: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(image: std.string) -> Void {
    self.closure(String(image))
  }
