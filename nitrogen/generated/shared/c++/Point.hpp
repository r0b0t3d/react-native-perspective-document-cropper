...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::customcrop::Point> final {
    static inline margelo::nitro::customcrop::Point fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::customcrop::Point(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::customcrop::Point& arg) {
